...
void trdclass_ps25::Loop() {
  ...
  f125_fit = new TH2F("f125_fit","Triple GEM-TRD Track Fit; Time Response (8ns) ; X Channel",200,0.5,200.5,240,-0.5,239.5);
  mmg1_f125_fit = new TH2F("mmg1_f125_fit","MMG1-TRD Track Fit; Time Response (8ns) ; X Channel",200,0.5,200.5,240,-0.5,239.5);
  urw_f125_fit = new TH2F("urw_f125_fit","uRWELL-TRD Track Fit; Time Response (8ns) ; X Channel",200,0.5,200.5,120,-0.5,119.5);
  qgem_f125_fit = new TH2F("qgem_f125_fit","Quad GEM-TRD Track Fit; Time Response (8ns) ; X Channel",200,0.5,200.5,240,-0.5,239.5);
  ...
  //////
  f125_el = new TH1F("f125_el","Triple GEM-TRD f125 Peak Amp; ADC Amplitude ; Counts ",100,0.,4096);          HistList->Add(f125_el);
  f125_el_max = new TH1F("f125_el_max","GEM-TRD f125 Max Amp; ADC Amplitude ; Counts ",100,0.,4096);          HistList->Add(f125_el_max);
  qgem_f125_el = new TH1F("qgem_f125_el","Quad GEM-TRD f125 Peak Amp; ADC Amplitude ; Counts ",100,0.,4096);       HistList->Add(qgem_f125_el);
  qgem_f125_el_max = new TH1F("qgem_f125_el_max","Quad GEM-TRD f125 Max Amp; ADC Amplitude ; Counts ",100,0.,4096);           HistList->Add(qgem_f125_el_max);
  mmg1_f125_el = new TH1F("mmg1_f125_el","MMG1-TRD f125 Peak Amp; ADC Amplitude ; Counts ",100,0.,4096);       HistList->Add(mmg1_f125_el);
  urw_f125_el_x = new TH1F("urw_f125_el_x","uRWELL-TRD X f125 Peak Amp; ADC Amplitude ; Counts ",100,0.,4096);       HistList->Add(urw_f125_el_x);
  urw_f125_el_y = new TH1F("urw_f125_el_y","uRWELL-TRD Y f125 Peak Amp; ADC Amplitude ; Counts ",100,0.,4096);       HistList->Add(urw_f125_el_y);
  mmg1_f125_el_max = new TH1F("mmg1_f125_el_max","MMG1-TRD f125 Max Amp; ADC Amplitude ; Counts ",100,0.,4096);           HistList->Add(mmg1_f125_el_max);
  urw_f125_el_xmax = new TH1F("urw_f125_el_xmax","uRWELL-TRD X f125 Max Amp; ADC Amplitude ; Counts ",100,0.,4096);           HistList->Add(urw_f125_el_xmax);
  urw_f125_el_ymax = new TH1F("urw_f125_el_ymax","uRWELL-TRD Y f125 Max Amp; ADC Amplitude ; Counts ",100,0.,4096);           HistList->Add(urw_f125_el_ymax);
  tgem_mmg1_doubleY = new TH2F("tgem_mmg1_doubleY","TRD Y Correlation (SRS) ; Triple GEM-TRD Y Chan ; MMG1-TRD Y Chan ",102,-0.2,102.2,102,-0.2,102.2);    tgem_mmg1_doubleY->SetStats(0);  HistList->Add(tgem_mmg1_doubleY);
  tgem_qgem_doubleY = new TH2F("tgem_qgem_doubleY","TRD Y Correlation (SRS) ; Triple GEM-TRD Y Chan ; Quad GEM-TRD Y Chan ",102,-0.2,102.2,102,-0.2,102.2);    tgem_qgem_doubleY->SetStats(0);  HistList->Add(tgem_qgem_doubleY);
  ...
  tgem_peak_y = new TH1F("tgem_peak_y","Triple GEM-TRD Peak Y Position (SRS) ; Y [mm] ",128,-0.2,102.2);  HistList->Add(tgem_peak_y);
  htgem_peak_y_height = new TH1F("htgem_peak_y_height","Triple GEM-TRD Peak Amplitudes in Y ; ADC Value ",100,0.,4096.);  HistList->Add(htgem_peak_y_height);
  qgem_peak_y = new TH1F("qgem_peak_y","Quad GEM-TRD Peak Y Position (SRS) ; Y [mm] ",128,-0.2,102.2);  HistList->Add(qgem_peak_y);
  hqgem_peak_y_height = new TH1F("hqgem_peak_y_height","Quad GEM-TRD Peak Amplitudes in Y ; ADC Value ",100,0.,4096.);  HistList->Add(hqgem_peak_y_height);
  
  hgemtrkr_1_tgem = new TH2F("hgemtrkr_1_tgem","GEM-TRKR1 & Triple GEM-TRD Y Correlation; Triple GEM-TRD Y [mm]; GEM-TRKR1 Y [mm] ",128,-0.2,102.2,128,-0.2,102.2); hgemtrkr_1_tgem->SetStats(0); HistList->Add(hgemtrkr_1_tgem);
  ...
  hgemtrkr_1_qgem = new TH2F("hgemtrkr_1_qgem","GEM-TRKR1 & Quad GEM-TRD Y Correlation; Quad GEM-TRD Y [mm]; GEM-TRKR1 Y [mm] ",128,-0.2,102.2,128,-0.2,102.2); hgemtrkr_1_qgem->SetStats(0); HistList->Add(hgemtrkr_1_qgem);
  
  //--External Tracking
  TH1F *f125_el_tracker_hits = new TH1F("f125_el_tracker_hits","GEM-TRD Track Extr. Hits for Cosmic; X Chan [mm]",128,-0.2,102.2);   HistList->Add(f125_el_tracker_hits);
  TH1F *f125_el_tracker_eff = new TH1F("f125_el_tracker_eff","GEM-TRD Track Eff. for Cosmic; X Chan [mm]",128,-0.2,102.2);   HistList->Add(f125_el_tracker_eff);
  TH1F *tgem_residuals = new TH1F("tgem_residuals","Triple GEM-TRD Residual Hits; X Chan [mm] (actual - expected)",250.,-25,25);   HistList->Add(tgem_residuals);
  TH1F *tgem_residualscorr = new TH1F("tgem_residualscorr","Triple GEM-TRD Residual Hits WITH CORR.; X Chan [mm] (actual - expected)",250.,-25,25);   HistList->Add(tgem_residualscorr);
  TH2F *tgem_residual_ch = new TH2F("tgem_residual_ch","Triple GEM-TRD Residual Hits vs Chan; X Chan [mm] (actual); X Chan [mm] (actual - expected)",65, 34.5, 62.5,35,-7.5,6.5); tgem_residual_ch->SetStats(0); HistList->Add(tgem_residual_ch);
  //TH1F *mmg1_f125_el_tracker_hits = new TH1F("mmg1_f125_el_tracker_hits","MMG1-TRD Track Extr. Hits for Cosmic; X Chan [mm]",128,-0.2,102.2);   HistList->Add(mmg1_f125_el_tracker_hits);
  //TH1F *mmg1_f125_el_tracker_eff = new TH1F("mmg1_f125_el_tracker_eff","MMG1-TRD Track Eff. for Cosmic; X Chan [mm]",128,-0.2,102.2);   HistList->Add(mmg1_f125_el_tracker_eff);
  ...
  //-- Amplitude Histos --
  f125_el_amp2d = new TH2F("f125_el_amp2d","Triple GEM-TRD ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,240,-0.5,239.5); f125_el_amp2d->SetStats(0); HistList->Add(f125_el_amp2d);
  ...
  qgem_f125_el_amp2d = new TH2F("qgem_f125_el_amp2d","Quad GEM-TRD ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,240,-0.5,239.5); qgem_f125_el_amp2d->SetStats(0); HistList->Add(qgem_f125_el_amp2d);
  ...
  urw_f125_x_amp2d = new TH2F("urw_f125_x_amp2d","uRWELL-TRD X ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,120,-0.5,119.5); urw_f125_x_amp2d->SetStats(0); HistList->Add(urw_f125_x_amp2d);
  ...
  mmg1_f125_el_amp2d = new TH2F("mmg1_f125_el_amp2d","MMG1-TRD ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,240,-0.5,239.5); mmg1_f125_el_amp2d->SetStats(0); HistList->Add(mmg1_f125_el_amp2d);
  ...
  urw_f125_y_amp2d = new TH2F("urw_f125_y_amp2d","uRWELL-TRD Y ADC Amp in Time; Time Response (8ns) ; Y Channel ",200,0.5,200.5,120,-0.5,119.5); urw_f125_y_amp2d->SetStats(0); HistList->Add(urw_f125_y_amp2d);
  ...
  f125_el_amp2ds = new TH2F("f125_el_amp2ds","Triple GEM-TRD ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,240,-0.5,239.5); f125_el_amp2ds->SetStats(0); HistList->Add(f125_el_amp2ds);
  qgem_f125_el_amp2ds = new TH2F("qgem_f125_el_amp2ds","Quad GEM-TRD ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,240,-0.5,239.5); qgem_f125_el_amp2ds->SetStats(0); HistList->Add(qgem_f125_el_amp2ds);
  urw_f125_x_amp2ds = new TH2F("urw_f125_x_amp2ds","uRWELL-TRD X ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,120,-0.5,119.5); urw_f125_x_amp2ds->SetStats(0); HistList->Add(urw_f125_x_amp2ds);
  mmg1_f125_el_amp2ds = new TH2F("mmg1_f125_el_amp2ds","MMG1-TRD ADC Amp in Time; Time Response (8ns) ; X Channel ",200,0.5,200.5,240,-0.5,239.5); mmg1_f125_el_amp2ds->SetStats(0); HistList->Add(mmg1_f125_el_amp2ds);
  urw_f125_y_amp2ds = new TH2F("urw_f125_y_amp2ds","uRWELL-TRD Y ADC Amp in Time; Time Response (8ns) ; Y Channel ",200,0.5,200.5,120,-0.5,119.5); urw_f125_y_amp2ds->SetStats(0); HistList->Add(urw_f125_y_amp2ds);
  ...
  //hgemPulseDiff_el = new TH1F("hgemPulseDiff_el","GEM Pulse Distance from MMG1 Track; Distance [mm]",250,-50.,50.); HistList->Add(hgemPulseDiff_el);
  //hmmg1PulseDiff_el = new TH1F("hmmg1PulseDiff_el","MMG1 Pulse Distance from GEM Track; Distance [mm]",250,-50.,50.); HistList->Add(hmmg1PulseDiff_el);
  ...
  TFile* fHits;
    ...
    tgem_zHist = new TH1F("tgem_zHist", "tgem_zHist", 20, 80., 200.);
    qgem_zHist = new TH1F("qgem_zHist", "qgem_zHist", 20, 80., 200.);
    ...
    EVENT_VECT_GEM->Branch("xch_max",&tgem_xch_max,"tgem_xch_max/I");
    ...
    //-- Quad GEM-TRD
    EVENT_VECT_QGEM = new TTree("qgem_hits","Quad-GEM TTree with single track hit info");
    EVENT_VECT_QGEM->Branch("event_num",&event_num,"event_num/I");
    EVENT_VECT_QGEM->Branch("nhit",&qgem_nhit,"qgem_nhit/I");
    EVENT_VECT_QGEM->Branch("nclu",&qgem_nclu,"qgem_nclu/I");
    EVENT_VECT_QGEM->Branch("xpos",&qgem_xpos);
    EVENT_VECT_QGEM->Branch("zpos",&qgem_zpos);
    EVENT_VECT_QGEM->Branch("dedx",&qgem_dedx);
    EVENT_VECT_QGEM->Branch("zHist",&qgem_zHist_vect);
    EVENT_VECT_QGEM->Branch("xposc",&qgem_clu_xpos);
    EVENT_VECT_QGEM->Branch("zposc",&qgem_clu_zpos);
    EVENT_VECT_QGEM->Branch("dedxc",&qgem_clu_dedx);
    EVENT_VECT_QGEM->Branch("widthc",&qgem_clu_width);
    EVENT_VECT_QGEM->Branch("xposc_max",&qgem_clu_xpos_max,"qgem_clu_xpos_max/f");
    EVENT_VECT_QGEM->Branch("zposc_max",&qgem_clu_zpos_max,"qgem_clu_zpos_max/f");
    EVENT_VECT_QGEM->Branch("dedxc_max",&qgem_clu_dedx_max,"qgem_clu_dedx_max/f");
    EVENT_VECT_QGEM->Branch("widthc_max",&qgem_clu_width_max,"qgem_clu_width_max/f");
    EVENT_VECT_QGEM->Branch("dedxc_tot",&qgem_clu_dedx_tot,"qgem_clu_dedx_tot/f");
    EVENT_VECT_QGEM->Branch("xch_max",&qgem_xch_max,"qgem_xch_max/I");
    EVENT_VECT_QGEM->Branch("amp_max",&qgem_amp_max,"qgem_amp_max/f");
    EVENT_VECT_QGEM->Branch("time_max",&qgem_time_max,"qgem_time_max/f");
    EVENT_VECT_QGEM->Branch("chi2",&qgem_chi2cc);
    EVENT_VECT_QGEM->Branch("Fint",&qgem_integral);
    EVENT_VECT_QGEM->Branch("a0",&qgem_a0);
    EVENT_VECT_QGEM->Branch("a1",&qgem_a1);
    ...
    EVENT_VECT_URW->Branch("xch_max",&urw_xch_max,"urw_xch_max/I");
  ...
  for (jentry=FirstEvt; jentry<nentries; jentry++) { //-- Event Loop --
    ...
    qgem_dedx.clear();
    qgem_zHist->Reset();
    qgem_zHist_vect.clear();
    qgem_clu_xpos.clear();
    qgem_clu_zpos.clear();
    qgem_clu_dedx.clear();
    qgem_clu_width.clear();
    qgem_clu_xpos_max=0;
    qgem_clu_zpos_max=0;
    qgem_clu_dedx_max=0;
    qgem_clu_width_max=0;
    qgem_clu_dedx_tot=0;
    qgem_amp_max=0;
    qgem_xch_max=0;
    qgem_time_max=0;
    ...
    */
    ...
    ULong64_t gt_1_idx_x = 0, gt_1_idx_y=0, gt_2_idx_x = 0, gt_2_idx_y = 0, gt_3_idx_x = 0, gt_3_idx_y = 0, mmg1_idx_y=0, tgem_idx_y=0, qgem_idx_y=0;
    ...
    double qgem_peak_pos_y[gem_peak_count];
    double qgem_peak_y_height[gem_peak_count];
    ...
    for (ULong64_t i=0; i<gem_peak_count; i++) {
      ...
      qgem_peak_pos_y[gem_peak_count] = -1000;
      qgem_peak_y_height[gem_peak_count] = -1000;
    }
    ...
    for (ULong64_t i=0; i<gem_peak_count; i++) { //-- SRS Peaks Loop
      ...
      if (gem_peak_plane_name->at(i) == "GEMTR1X") {
        ...
        //gt_1_idx_x++; Count("gt1_x");
          ...
          if (gemtrkr_1_peak_y_height[gt_1_idx_y]>50.) gt_1_idx_y++; Count("gt1_y");
        ...
        if (gemtrkr_2_peak_x_height[gt_2_idx_x]>50.) gt_2_idx_x++; Count("gt2_x");
        //gt_2_idx_x++; Count("gt2_x");
          ...
          if (gemtrkr_2_peak_y_height[gt_2_idx_y]>50.) gt_2_idx_y++; Count("gt2_y");
        ...
        if (gemtrkr_3_peak_x_height[gt_3_idx_x]>50.) gt_3_idx_x++; Count("gt3_x");
        //gt_3_idx_x++; Count("gt3_x");
          ...
          if (gemtrkr_3_peak_y_height[gt_3_idx_y]>50.) gt_3_idx_y++; Count("gt3_y");
          //gt_3_idx_y++; Count("gt3_y");
      } if (gem_peak_plane_name->at(i) == "MMG1TRDY" && RunNum<runSwitch) {
        qgem_peak_pos_y[qgem_idx_y] = gem_peak_real_pos->at(i);
        if (qgem_peak_pos_y[qgem_idx_y]<0) qgem_peak_pos_y[qgem_idx_y]+=50.; else if (qgem_peak_pos_y[qgem_idx_y]>0) qgem_peak_pos_y[qgem_idx_y]-=50.;  qgem_peak_pos_y[qgem_idx_y]*=-1.;  qgem_peak_pos_y[qgem_idx_y]+=50.;
        qgem_peak_y_height[qgem_idx_y] = gem_peak_height->at(i);
        //if (qgem_peak_y_height[qgem_idx_y]>50.) qgem_idx_y++; Count("qgem_y");
        qgem_idx_y++; Count("qgem_y");
        ...
        if (mmg1_peak_y_height[mmg1_idx_y]>50.) mmg1_idx_y++; Count("mmg1_y");
        //mmg1_idx_y++; Count("mmg1_y");
        } 
        if (gem_peak_plane_name->at(i) == "VU_GEMTRDY") {
        tgem_peak_pos_y[tgem_idx_y] = gem_peak_real_pos->at(i);
        if (tgem_peak_pos_y[tgem_idx_y]<0) tgem_peak_pos_y[tgem_idx_y]+=50.; else if (tgem_peak_pos_y[tgem_idx_y]>0) tgem_peak_pos_y[tgem_idx_y]-=50.;  tgem_peak_pos_y[tgem_idx_y]*=-1.;  tgem_peak_pos_y[tgem_idx_y]+=50.;
        tgem_peak_y_height[tgem_idx_y] = gem_peak_height->at(i);
        if (tgem_peak_y_height[tgem_idx_y]>50.) tgem_idx_y++; Count("tgem_y");
    ...
    for (ULong64_t k=0; k<qgem_idx_y; k++) {
      qgem_peak_y->Fill(qgem_peak_pos_y[k]);
      hqgem_peak_y_height->Fill(qgem_peak_y_height[k]);
      for (ULong64_t j=0; j<gt_1_idx_y; j++) {
        hgemtrkr_1_qgem->Fill(qgem_peak_pos_y[k], gemtrkr_1_peak_pos_y[j]);
      }
    }
    ...
    for (ULong64_t k=0; k<tgem_idx_y; k++) {
      tgem_peak_y->Fill(tgem_peak_pos_y[k]);
      htgem_peak_y_height->Fill(tgem_peak_y_height[k]);
      for (ULong64_t j=0; j<mmg1_idx_y; j++) {
        tgem_mmg1_doubleY->Fill(tgem_peak_pos_y[k], mmg1_peak_pos_y[j]);
      }
      for (ULong64_t j=0; j<qgem_idx_y; j++) {
        tgem_qgem_doubleY->Fill(tgem_peak_pos_y[k], qgem_peak_pos_y[j]);
      }
      for (ULong64_t j=0; j<gt_1_idx_y; j++) {
        hgemtrkr_1_tgem->Fill(tgem_peak_pos_y[k], gemtrkr_1_peak_pos_y[j]);
      }
    }
    ...
    //==================================================================================================
      ...
      double chi2cc_tgem=-999., chi2cc_mmg1=-999.,  chi2cc_urw=-999, chi2cc_qgem=-999.;
      double integral_tgem=0., integral_mmg1=0., integral_urw=0., integral_qgem=0.;
      double tgem_ampmax=-1., mmg1_ampmax=-1., urw_xampmax=-1., urw_yampmax=-1., tgem_xchanmax=-1, mmg1_xchanmax=-1, urw_xchanmax=-1.,  urw_ychanmax=-1., qgem_ampmax=-1.,  qgem_xchanmax=-1;
      int tgem_timemax=0, mmg1_timemax=0, urw_xtimemax=0, urw_ytimemax=0, qgem_timemax=0;
      ULong64_t tgem_idx_x=0, mmg1_idx_x=0, urw_idx_x=0, urw_idx_y=0, qgem_idx_x=0;
      double tgem_pos_x[f125_pulse_count], mmg1_pos_x[f125_pulse_count], urw_pos_x[f125_pulse_count], urw_pos_y[f125_pulse_count], tgem_amp_x[f125_pulse_count], mmg1_amp_x[f125_pulse_count], urw_amp_x[f125_pulse_count], urw_amp_y[f125_pulse_count], qgem_pos_x[f125_pulse_count], qgem_amp_x[f125_pulse_count];
      ...
      char qgemf125Title[80]; sprintf(qgemf125Title,"Quad GEM-TRD:  Event=%lld Run=%d; z pos [time *8ns]; y pos [ch #]",jentry,RunNum);
      qgem_f125_fit->SetTitle(qgemf125Title);
      if (qgem_f125_fit->GetEntries()!=0) {
        std::pair<Double_t, Double_t> fitResult  = TrkFit(qgem_f125_fit,fx2,"fx2",1);
        chi2cc_qgem = fitResult.first;
        integral_qgem = fitResult.second;
      }
      double a0_qgem = fx2.GetParameter(0);
      double a1_qgem = fx2.GetParameter(1);
      ...
      for (ULong64_t i=0; i<f125_pulse_count; i++) { //--- Fadc125 Pulse Loop
        ...
        int quadGemChan = Get4GEMChan(fADCChan, fADCSlot, RunNum);
        float quadGemChan_x = quadGemChan*0.4+3.2; // to [mm]
        ...
        if (quadGemChan>-1 && amp>QGEM_THRESH) {
          qgem_f125_el_amp2ds->Fill(time,quadGemChan,amp);
          if (qgem_ampmax<amp) {
            qgem_ampmax=amp;
            qgem_timemax=time;
            qgem_xchanmax=quadGemChan_x;
          }
        }
      ...
      double tgem_el_chan_max=tgem_xchanmax;
      double mmg1_el_chan_max=mmg1_xchanmax;
      double qgem_el_chan_max=qgem_xchanmax;
      ...
      for (ULong64_t i=0; i<f125_pulse_count; i++) {
        ...
        int quadGemChan = Get4GEMChan(fADCChan, fADCSlot, RunNum);
        double quadGemChan_x = quadGemChan*0.4 + 3.2;
      	int mmg1Chan = GetMMG1Chan(fADCChan, fADCSlot, RunNum);
        ...
        if (amp>QGEM_THRESH && quadGemChan>-1) {
            ...
            qgem_pos_x[i] = quadGemChan_x;
            qgem_amp_x[i] = amp;
            qgem_idx_x++;
            qgem_f125_el_amp2d->Fill(time,quadGemChan,amp);
            qgem_f125_xVSamp->Fill(quadGemChan,amp);
            qgem_f125_el->Fill(amp);
            qgem_xpos.push_back(quadGemChan);
            qgem_dedx.push_back(amp);
            qgem_zpos.push_back(time);
            qgem_nhit++;
            qgem_zHist->Fill(time,amp);
      ...
      //==================== Max Amplitude histos ============================
        ...
        if (qgem_ampmax>0) {
          qgem_f125_el_max->Fill(qgem_ampmax);
        }
        if (mmg1_ampmax>0) {
      ...
      qgem_amp_max=qgem_ampmax;
      qgem_time_max=qgem_timemax;
      qgem_xch_max=qgem_xchanmax;
      qgem_chi2cc.push_back(chi2cc_qgem);
      qgem_integral.push_back(integral_qgem);
      ...
      for (int i=1; i<21; i++) {
        ...
        qgem_zHist_vect.push_back(qgem_zHist->GetBinContent(i));
      ...
      for (ULong64_t i=0; i<gt_1_idx_x; i++) {
        if (gemtrkr_1_peak_pos_x[i]>1.) tgem_gt1_xcorr->Fill((tgem_xchanmax), gemtrkr_1_peak_pos_x[i]);
        if (gemtrkr_1_peak_pos_x[i]>1.) qgem_gt1_xcorr->Fill((qgem_xchanmax), gemtrkr_1_peak_pos_x[i]);
      }
      for (ULong64_t i=0; i<gt_2_idx_x; i++) {
        if (gemtrkr_2_peak_pos_x[i]>1.) tgem_gt2_xcorr->Fill((tgem_xchanmax), gemtrkr_2_peak_pos_x[i]);
        if (gemtrkr_2_peak_pos_x[i]>1.) qgem_gt2_xcorr->Fill((qgem_xchanmax), gemtrkr_2_peak_pos_x[i]);
      }
      for (ULong64_t i=0; i<gt_3_idx_x; i++) {
        if (gemtrkr_3_peak_pos_x[i]>1.) tgem_gt3_xcorr->Fill((tgem_xchanmax), gemtrkr_3_peak_pos_x[i]);
        if (gemtrkr_3_peak_pos_x[i]>1.) qgem_gt3_xcorr->Fill((qgem_xchanmax), gemtrkr_3_peak_pos_x[i]);
      }
      
      for (ULong64_t j=0; j<urw_idx_x; j++) {
        if (urw_pos_x[j]>1.) {
          for (ULong64_t i=0; i<urw_idx_y; i++) {
            if (urw_pos_y[i]>1.) hurw_xy->Fill(urw_pos_x[j], urw_pos_y[i]);
          }
          for (ULong64_t i=0; i<qgem_idx_x; i++) {
            if (qgem_pos_x[i]>1.) urw_qgem_xcorr->Fill(urw_pos_x[j], qgem_pos_x[i]);
          }
      ...
      for (ULong64_t j=0; j<qgem_idx_x; j++) {
        if (qgem_pos_x[j]>1.) {
          for (ULong64_t i=0; i<qgem_idx_y; i++) {
            if (qgem_peak_pos_y[i]>0.) hqgem_xy->Fill(qgem_pos_x[j], qgem_peak_pos_y[i]);
          }
        }
      }
      for (ULong64_t j=0; j<tgem_idx_x; j++) {
        if (tgem_pos_x[j]>1.) {
          for (ULong64_t i=0; i<tgem_idx_y; i++) {
            if (tgem_peak_pos_y[i]>0.) htgem_xy->Fill(tgem_pos_x[j], tgem_peak_pos_y[i]);
          }
          for (ULong64_t i=0; i<mmg1_idx_x; i++) {
            if (mmg1_pos_x[i]>1.) tgem_mmg1_xcorr->Fill(tgem_pos_x[j], mmg1_pos_x[i]);
          }
          for (ULong64_t i=0; i<qgem_idx_x; i++) {
            if (qgem_pos_x[i]>1.) tgem_qgem_xcorr->Fill(tgem_pos_x[j], qgem_pos_x[i]);
          }
        }
      }
      for (ULong64_t i=0; i<tgem_idx_y; i++) {
        if (tgem_peak_pos_y[i]>0.) {
          for (ULong64_t j=0; j<mmg1_idx_y; j++) {
            if (mmg1_peak_pos_y[j]>0.) tgem_mmg1_ycorr->Fill(tgem_peak_pos_y[i], mmg1_peak_pos_y[j]);
          }
        }
      }
      for (ULong64_t j=0; j<mmg1_idx_y; j++) {
      ...
      for (ULong64_t i=0; i<gt_1_idx_x; i++) {
        if (gemtrkr_1_peak_pos_x[i]>1.) mmg1_gt1_xcorr->Fill((mmg1_xchanmax), gemtrkr_1_peak_pos_x[i]);
      }
      for (ULong64_t i=0; i<gt_2_idx_x; i++) {
        if (gemtrkr_2_peak_pos_x[i]>1.) mmg1_gt2_xcorr->Fill((mmg1_xchanmax), gemtrkr_2_peak_pos_x[i]);
      }
      for (ULong64_t i=0; i<gt_3_idx_x; i++) {
        if (gemtrkr_3_peak_pos_x[i]>1.) mmg1_gt3_xcorr->Fill((mmg1_xchanmax), gemtrkr_3_peak_pos_x[i]);
      }
      
      hurw_max_xy->Fill(urw_xchanmax, urw_ychanmax);
...
/*      gem_nclu=nhits;
      ...
      */
      ...
      if (qgem_nhit>0) EVENT_VECT_QGEM->Fill();
  ...
  TH1D *qgem_f125_drift = qgem_f125_el_amp2d->ProjectionX("qgem_f125_drift",100,135);
  TH1D *qgem_f125_drift_c = new TH1D(*f125_drift); f125_drift_c->SetStats(0);
  double qgemDriftScale = 1./qgem_f125_drift_c->GetEntries();
  qgem_f125_drift_c->Scale(qgemDriftScale);
  ...
  TH1D *urw_f125_ydrift = urw_f125_y_amp2d->ProjectionX("urw_f125_ydrift",25,50);
  TH1D *urw_f125_ydrift_c = new TH1D(*urw_f125_ydrift); urw_f125_ydrift_c->SetStats(0);
  double urwyDriftScale = 1./urw_f125_ydrift_c->GetEntries();
  urw_f125_ydrift_c->Scale(urwyDriftScale);
  f125_drift_c->SetLineColor(4);  f125_drift_c->SetLineWidth(2);  HistList->Add(f125_drift_c);
  qgem_f125_drift_c->SetLineColor(7); qgem_f125_drift_c->SetLineWidth(2);  HistList->Add(qgem_f125_drift_c);
  ...
  urw_f125_ydrift_c->SetLineColor(6); urw_f125_ydrift_c->SetLineWidth(2);  HistList->Add(urw_f125_ydrift_c);
  ...
  //=====================================================================================
    ...
    cc=NextPlot(nxd,nyd);
    if (RunNum<runSwitch) { hqgem_nhits->Draw(); }
    else { hmmg1_nhits->Draw(); }
    ...
    if (RunNum<runSwitch) {
      cc=NextPlot(nxd,nyd);  qgem_gt1_xcorr->Draw("colz");
      cc=NextPlot(nxd,nyd);  qgem_gt2_xcorr->Draw("colz");
      cc=NextPlot(nxd,nyd);  qgem_gt3_xcorr->Draw("colz");
    } else {
    ...
    //nxd=2; nyd=3;
    if (RunNum<runSwitch) {
      cc=NextPlot(nxd,nyd); qgem_peak_y->Draw();
      cc=NextPlot(nxd,nyd); hqgem_peak_y_height->Draw();
      cc=NextPlot(nxd,nyd); tgem_qgem_doubleY->Draw("colz");
    } else {
      cc=NextPlot(nxd,nyd); mmg1_peak_y->Draw();
      cc=NextPlot(nxd,nyd); hmmg1_peak_y_height->Draw();
      cc=NextPlot(nxd,nyd); tgem_mmg1_doubleY->Draw("colz");
    }
   ...
   //---------------------  page 3 --------------------
    ...
    if (RunNum<runSwitch) {
      cc=NextPlot(nxd,nyd);   gPad->SetLogy();  qgem_f125_el->Draw();
    } else {
    ...
    if (RunNum<runSwitch) {
      cc=NextPlot(nxd,nyd);   gPad->SetLogy();  qgem_f125_el_max->Draw();
    } else {
   ...
   //---------------------  page 3a --------------------
    ...
    if (RunNum<runSwitch) {
      cc=NextPlot(nxd,nyd);   qgem_f125_xVSamp->Draw("colz");
    } else {
   ...
   //------------- MAX COMPARISONS ---------------
    ...
    cc=NextPlot(nxd,nyd);  mmg1_f125_el_max->Draw("same");  
    urw_f125_el_xmax->Scale(1./(urw_f125_el_xmax->GetEntries()));  urw_f125_el_xmax->SetLineColor(2);
